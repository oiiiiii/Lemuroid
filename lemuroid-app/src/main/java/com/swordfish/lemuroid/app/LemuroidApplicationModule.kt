...
abstract class LemuroidApplicationModule {
    ...
    @PerActivity
    @ContributesAndroidInjector
    abstract fun coresStorageFrameworkPickerLauncher(): com.swordfish.lemuroid.app.shared.settings.CoresStorageFrameworkPickerLauncher
    ...
    companion object {
        ...
        fun retrogradeDb(app: LemuroidApplication) =
            Room.databaseBuilder(app, RetrogradeDatabase::class.java, RetrogradeDatabase.DB_NAME)
                ...
                .addMigrations(GameSearchDao.MIGRATION_7_8, Migrations.VERSION_8_9, GameSearchDao.MIGRATION_9_10)
