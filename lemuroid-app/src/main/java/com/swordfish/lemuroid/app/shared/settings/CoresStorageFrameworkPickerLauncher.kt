...
class CoresStorageFrameworkPickerLauncher : RetrogradeActivity() {
    @Inject
    ...
    override fun onActivityResult(
        ...
        if (requestCode == REQUEST_CODE_PICK_FOLDER && resultCode == Activity.RESULT_OK) {
            ...
            val preferenceKey = getString(com.swordfish.lemuroid.lib.R.string.pref_key_cores_folder)
    ...
    companion object {
        ...
        fun pickFolder(context: Context) {
            context.startActivity(Intent(context, CoresStorageFrameworkPickerLauncher::class.java))
        }
    }
}