...
import com.swordfish.lemuroid.app.shared.settings.CoresStorageFrameworkPickerLauncher
...
fun HomeScreen(
    ...
    HomeScreen(
        ...
        { CoresStorageFrameworkPickerLauncher.pickFolder(context) },
...
private fun HomeScreen(
    ...
    onSetCoresDirectoryClicked: () -> Unit,
) {
    Column(
        modifier =
            modifier
        ...
        AnimatedVisibility(state.showNoCoresFolderCard) {
            HomeNotification(
                titleId = R.string.home_empty_cores_title,
                messageId = R.string.home_empty_cores_message,
                actionId = R.string.home_empty_cores_action,
                onAction = onSetCoresDirectoryClicked,
